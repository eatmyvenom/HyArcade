...
async function refresh() {
    ...
    let accdata = await fetch("https://eatmyvenom.me/share/accounts.json", { cache: "no-store" });
...
async function handleTimed(timetype, accdata) {
    let accold = await fetch(`https://eatmyvenom.me/share/accounts.${timetype}.json`, { cache: "no-store" });
    accdata = JSON.parse(accdata);
