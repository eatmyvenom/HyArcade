...
async function genImg(account, game = "") {
  ...
  switch (`${game}`.toLowerCase()) {
    ...
    case "pg": {
      ...
      img.drawMcText(
        `&d${numberify(account.arcadeChallenges.partyGames)}`,
        img.canvas.width - x,
        (y += lineHeight),
        size,
        "center",
    ...
    case "frmhnt": {
      ...
      img.drawMcText("&dChallenges", img.canvas.width - x, (y += lineHeight), txtSize, "center");
      img.drawMcText(
        `&d${numberify(account.arcadeChallenges.farmhunt)}`,
        img.canvas.width - x,
        (y += lineHeight),
        size,
        "center",
    ...
    case "hysays": {
      ...
      img.drawMcText("&dChallenges", img.canvas.width - x, (y += lineHeight), txtSize, "center");
      img.drawMcText(
        `&d${numberify(account.arcadeChallenges.hypixelSays)}`,
        img.canvas.width - x,
        (y += lineHeight),
        size,
        "center",
    ...
    case "pain": {
      ...
      img.drawMcText("&dChallenges", img.canvas.width - x, (y += lineHeight), txtSize, "center");
      img.drawMcText(
        `&d${numberify(account.arcadeChallenges.holeInTheWall)}`,
        img.canvas.width - x,
        (y += lineHeight),
        size,
        "center",
    ...
    case "miniwalls": {
      ...
      img.drawMcText("&dChallenges", img.canvas.width - x, (y += lineHeight), txtSize, "center");
      img.drawMcText(
        `&d${numberify(account.arcadeChallenges.miniWalls)}`,
        img.canvas.width - x,
        (y += lineHeight),
        size,
        "center",
    ...
    case "football": {
      ...
      img.drawMcText("&dChallenges", img.canvas.width - x, (y += lineHeight), txtSize, "center");
      img.drawMcText(
        `&d${numberify(account.arcadeChallenges.football)}`,
        img.canvas.width - x,
        (y += lineHeight),
        size,
        "center",
    ...
    case "enderspleef": {
      ...
      img.drawMcText("&dChallenges", img.canvas.width - x, (y += lineHeight), txtSize, "center");
      img.drawMcText(
        `&d${numberify(account.arcadeChallenges.enderSpleef)}`,
        img.canvas.width - x,
        (y += lineHeight),
        size,
        "center",
    ...
    case "throwout": {
      ...
      img.drawMcText("&dChallenges", img.canvas.width - x, (y += lineHeight), txtSize, "center");
      img.drawMcText(
        `&d${numberify(account.arcadeChallenges.throwOut)}`,
        img.canvas.width - x,
        (y += lineHeight),
        size,
        "center",
    ...
    case "galaxywars": {
      ...
      img.drawMcText("&dChallenges", img.canvas.width - x, (y += lineHeight), txtSize, "center");
      img.drawMcText(
        `&d${numberify(account.arcadeChallenges.galaxyWars)}`,
        img.canvas.width - x,
        (y += lineHeight),
        size,
        "center",
    ...
    case "dragonwars": {
      ...
      img.drawMcText("&dChallenges", img.canvas.width - x, (y += lineHeight), txtSize, "center");
      img.drawMcText(
        `&d${numberify(account.arcadeChallenges.dragonWars)}`,
        img.canvas.width - x,
        (y += lineHeight),
        size,
        "center",
    ...
    case "bountyhunters": {
      ...
      img.drawMcText("&dChallenges", img.canvas.width - x, (y += lineHeight), txtSize, "center");
      img.drawMcText(
        `&d${numberify(account.arcadeChallenges.bountyHunters)}`,
        img.canvas.width - x,
        (y += lineHeight),
        size,
        "center",
    ...
    case "blockingdead": {
      ...
      img.drawMcText("&dChallenges", img.canvas.width - x, (y += lineHeight), txtSize, "center");
      img.drawMcText(
        `&d${numberify(account.arcadeChallenges.blockingDead)}`,
        img.canvas.width - x,
        (y += lineHeight),
        size,
        "center",
    ...
    case "hidenseek":
    case "hideseek": {
      await img.addBackground(
        "resources/status/Arcade-hide-and-seek-party-pooper-1.png",
        0,
        0,
        4000,
        2040,
      ...
      img.drawMcText("&dChallenges", img.canvas.width - x, (y += lineHeight), txtSize, "center");
      img.drawMcText(
        `&d${numberify(account.arcadeChallenges.hideAndSeek)}`,
        img.canvas.width - x,
        (y += lineHeight),
        size,
        "center",
      ...
      img.drawMcText(
        `&b${numberify(account.hideAndSeek.objectives)}`,
        img.canvas.width - x,
        (y += lineHeight),
        size,
        "center",
      ...
      img.drawMcText(
        `&a${numberify(account.hideAndSeek.kills)}`,
        img.canvas.width - x,
        (y += lineHeight),
        size,
        "center",
    ...
    case "zombies": {
      ...
      img.drawMcText(
        `&b${numberify(account.zombies.wins_zombies_badblood ?? 0)}`,
        x,
        (y += lineHeight),
        size,
        "center",
      ...
      img.drawMcText(
        `&e${numberify(account.zombies.wins_zombies_alienarcadium ?? 0)}`,
        x,
        (y += lineHeight),
        size,
        "center",
      ...
      img.drawMcText("&dChallenges", img.canvas.width - x, (y += lineHeight), txtSize, "center");
      img.drawMcText(
        `&d${numberify(account.arcadeChallenges.zombies)}`,
        img.canvas.width - x,
        (y += lineHeight),
        size,
        "center",
    ...
    case "ctwkills": {
      ...
      img.drawMcText("&dChallenges", img.canvas.width - x, (y += lineHeight), txtSize, "center");
      img.drawMcText(
        `&d${numberify(account.arcadeChallenges.captureTheWool)}`,
        img.canvas.width - x,
        (y += lineHeight),
        size,
        "center",
    ...
    case "drawing": {
      ...
      img.drawMcText("&dChallenges", img.canvas.width - x, (y += lineHeight), txtSize, "center");
      img.drawMcText(
        `&d${numberify(account.arcadeChallenges.pixelPainters)}`,
        img.canvas.width - x,
        (y += lineHeight),
        size,
        "center",
    ...
    case "sea": {
      ...
      img.drawMcText(
        `&e${numberify(account.seasonalWins.foundEaster)}`,
        img.canvas.width - x,
        (y += lineHeight),
        size,
        "center",
      ...
      img.drawMcText(
        `&b${numberify(account.seasonalWins.foundHalloween)}`,
        img.canvas.width - x,
        (y += lineHeight),
        size,
        "center",
      ...
      img.drawMcText(
        `&e${numberify(account.seasonalWins.foundScuba)}`,
        img.canvas.width - x,
        (y += lineHeight),
        size,
        "center",
    ...
    default: {
      ...
      img.drawMcText(
        `&b${numberify(Math.floor(account.importance ?? 0))}`,
        img.canvas.width - x,
        (y += lineHeight),
        size,
        "center",
